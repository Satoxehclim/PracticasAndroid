package com.quetzalcodeescom.listasimagenesapp;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle b) {
        ...
        al.add(new ListaEntrada(R.drawable.buho,
                "BUHO", "Búho es el nombre común de aves de la familia Strigidae," +
                " del orden de las estrigiformes o  aves rapaces nocturnas. Habitualmente" +
        ...
        al.add(new ListaEntrada(R.drawable.colibri,
                "COLIBRÍ", "Los troquilinos (Trochilinae) son una subfamilia" +
                " de aves apodiformes de la familia Trochilidae, conocidas" +
                " vulgarmente como colibríes, quindes, tucusitos, picaflores," +
                " chupamirtos, chuparrosas, huichichiquis (idioma nahuatl)," +
                " mainumby (idioma guaraní) o guanumby."));
        al.add(new ListaEntrada(R.drawable.cuervo,
            "CUERVO", "El cuervo común (Corvus corax) es una especie de ave" +
                " paseriforme de la familia de los córvidos (Corvidae). Presente en" +
                " todo el hemisferio septentrional, es la especie de córvido con la " +
        ...
        al.add(new ListaEntrada(R.drawable.flamenco,
            "FLAMENCO", "Los fenicopteriformes (Phoenicopteriformes), los cuales" +
                " reciben el nombre vulgar de flamencos, son un orden de aves " +
                "neognatas, con un único género viviente: Phoenicopterus."));
        al.add(new ListaEntrada(R.drawable.kiwi,
                "KIWI", "Los kiwis (Apterix, gr. 'sin alas') son un género de " +
                "aves paleognatas compuesto por cinco especies endémicas de Nueva" +
                " Zelanda.1 2 Son aves no voladoras pequeñas, aproximadamente" +
                " del tamaño de una gallina."));
        al.add(new ListaEntrada(R.drawable.loro,
                "LORO", "Las Psitácidas (Psittacidae) son una familia de aves " +
                "psitaciformes llamadas comúnmente loros o papagayos, e incluye a los" +
                " guacamayos, las cotorras, los periquitos, los agapornis y formas afines."));
        al.add(new ListaEntrada(R.drawable.pavo,
                "PAVO", "Pavo es un género de aves galliformes de la familia" +
                " Phasianidae, que incluye dos especies, el pavo real común (Pavo cristatus)" +
                " y el pavo real cuelliverde (Pavo muticus).1"));
        al.add(new ListaEntrada(R.drawable.pinguino,
                "PINGÜINO", "Los pingüinos (familia Spheniscidae, orden" +
                " Sphenisciformes) son un grupo de aves marinas, no voladoras, que se " +
                "distribuyen únicamente en el Hemisferio Sur, sobre todo en " +
                "sus altas latitudes."));
